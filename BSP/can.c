...
//	TxMessage.StdId=0x12;			// 标准标识符 
	...
	mbox= CAN_Transmit(CAN1, &TxMessage);   // 请求发送，获取邮箱号
	i=0; 
	while((CAN_TransmitStatus(CAN1, mbox)==CAN_TxStatus_Failed)&&(i<0XFFF))i++;	//等待发送完成，带超时检测
	if(i>=0XFFF)return 1;  // 超时，发送失败
	return 0;	  // 发送成功
}
//can�ڽ������ݲ�ѯ
//buf:���ݻ�����;	 
